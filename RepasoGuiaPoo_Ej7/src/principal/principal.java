...
public class principal {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(p1.calcularIMC(p2));
        p1.esMayorDeEdad(p2);
        p1.mostrarPersona(p2);
        
        Persona p3 = p1.crearPersona();
        
        System.out.println(p1.calcularIMC(p3));
        p1.esMayorDeEdad(p3);
        p1.mostrarPersona(p3);
        
        Persona p4 = p1.crearPersona();
        
        System.out.println(p1.calcularIMC(p4));
        p1.esMayorDeEdad(p4);
        p1.mostrarPersona(p4);
        
        Persona p5 = p1.crearPersona();
        
        System.out.println(p1.calcularIMC(p5));
        p1.esMayorDeEdad(p5);
        p1.mostrarPersona(p5);
